...
public class SeleniumWait{
    ...
    public WebElement waitForElementToBeVisibles() {
        return (WebElement) wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath(".//a[contains(@href,'courseType')]"))));
    }
